package ormNext.controller.user;
...
public class UserController {
    ...
    public String update(@LoginUser User loginUser, @PathVariable String userId, @ModelAttribute("user") @Valid User newUser, BindingResult bindingResult) throws Exception {
